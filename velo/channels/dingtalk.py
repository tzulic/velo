...
class VeloDingTalkHandler(CallbackHandler):
    """
    Standard DingTalk Stream SDK Callback Handler.
    Parses incoming messages and forwards them to the Velo channel.
    """
...
class DingTalkChannel(BaseChannel):
    ...
    async def start(self) -> None:
        ...
        try:
            ...
            handler = VeloDingTalkHandler(self)
    ...
    async def _on_message(
        ...
        """Handle incoming message (called by VeloDingTalkHandler).
