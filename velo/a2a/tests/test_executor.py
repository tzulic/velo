...
class TestNanobotAgentExecutor:
    ...
    @pytest.mark.asyncio
    @patch("velo.a2a.executor.TaskUpdater")
    @patch("velo.a2a.executor.TaskState")
    @patch("velo.a2a.executor.Part")
    @patch("velo.a2a.executor.TextPart")
    async def test_execute_success(self, mock_text_part, mock_part, mock_state, mock_updater_cls):
        ...
        from velo.a2a.executor import NanobotAgentExecutor
