...
class TestBuildAgentCard:
    ...
    @patch("nanobot.a2a.card.AgentCard")
    @patch("nanobot.a2a.card.AgentCapabilities")
    @patch("nanobot.a2a.card.AgentSkill")
    @patch("nanobot.a2a.card.SkillsLoader")
    def test_uses_config_name_and_description(
        ...
        from nanobot.a2a.card import build_agent_card
